...
namespace Content.Client.Chemistry.UI
{
    ...
    public sealed partial class ReagentDispenserWindow : FancyWindow
    {
        ...
        Entity<LimitedChargesComponent?, AutoRechargeComponent?>? _chargesEntity;
        ...
        public ReagentDispenserWindow()
        {
            ...
            _chargesSystem = _entityManager.System<ChargesSystem>();
        }
        ...
        public void UpdateState(BoundUserInterfaceState state)
        {
            ...
            if (ent is not null)
            {
                _chargesEntity = new(
                    ent.Value,
                    _entityManager.GetComponentOrNull<LimitedChargesComponent>(ent),
                    _entityManager.GetComponentOrNull<AutoRechargeComponent>(ent)
                );
