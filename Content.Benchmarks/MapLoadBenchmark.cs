...
public class MapLoadBenchmark
{
    ...
    public static readonly string[] MapsSource = { /*"Empty", "Saltern", "Box", "Bagel", "Dev", "CentComm", "Atlas", "Core", "TestTeg", "Packed", "Origin", "Omega", "Cluster", "Reach", "Meta", "Marathon", "Europa", "MeteorArena", "Fland", "Oasis", "FlandHighPop", "OasisHighPop", "OriginHighPop", "Barratry", "Kettle", "Lambda", "Leonid", "Delta", "Amber", "Chloris", "Cog", "Serpentcrest",*/ "WonderBoxMaid", "AtomMaid", "BoxMaid", "TriumphMaid", "BagelMaid", "KettleMaid", "ScoupidiaMaid", "CentcommMaid", "OldBoxMaid" };
