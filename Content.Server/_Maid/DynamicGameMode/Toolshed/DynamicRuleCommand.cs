...
using Content.Server._Maid.DynamicGameMode.Rules;
using Content.Shared._Maid.DynamicGameMode.Rules;
using Content.Shared.Administration;
using Robust.Shared.Prototypes;
using Robust.Shared.Toolshed;

namespace Content.Server._Maid.DynamicGameMode.Toolshed;

[ToolshedCommand(Name = "dynamic"), AdminCommand(AdminFlags.Round)]
