...
cargo-console-menu-order-row-alerts-reason-absent = Не указана
...
cargo-console-menu-populate-orders-cargo-order-row-product-name-text = { $productName } (x{ $orderAmount } за {$orderPrice}$) от { $orderRequester }
...
cargo-console-menu-account-action-button = Обналичить
...
cargo-console-fund-withdraw-broadcast = [bold]{ $name } снял { $amount } кредитов
