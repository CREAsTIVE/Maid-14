...
chem-master-window-sort-type-none = Фильтр: Сначала старые
chem-master-window-sort-type-alphabetical = Фильтр: По алфавиту
chem-master-window-sort-type-quantity = Фильтр: Количество
chem-master-window-sort-type-latest = Фильтр: Сначала новые
