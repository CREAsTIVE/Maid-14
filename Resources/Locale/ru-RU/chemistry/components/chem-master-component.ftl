...
chem-master-window-volume-unit = ед.
chem-master-window-sort-type-none = Порядок: Сначала старые
chem-master-window-sort-type-alphabetical = Порядок: По алфавиту
chem-master-window-sort-type-quantity = Порядок: Количество
chem-master-window-sort-type-latest = Порядок: Сначала новые
