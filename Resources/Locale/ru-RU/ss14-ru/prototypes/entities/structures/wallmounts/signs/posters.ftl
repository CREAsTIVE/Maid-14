...
ent-PosterContrabandDonutCorp = Донут Корп.
    .desc = Этот плакат является несанкционированной рекламой Донут Корп.
...
ent-PosterContrabandPwrGame = Геймер Энерджи
    .desc = СИЛА, которой ЖАЖДУТ геймеры! В партнёрстве с компанией Салаты от Влады.
...
ent-PosterLegitPDAAd = Реклама ПДА
    .desc = Плакат, рекламирующий новейшие ПДА от поставщиков NanoTrasen.
